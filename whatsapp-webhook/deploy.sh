...
AGENT_LANGUAGE_CODE=${AGENT_LANGUAGE_CODE:-"en"}
ROUTING_TARGET=${ROUTING_TARGET:-"AGENT_ENGINE"} # "DIALOGFLOW" or "AGENT_ENGINE"
AGENT_ID=${AGENT_ID:-"1872779463893188608"} # Default if not set in environment
SEND_WHATSAPP_RESPONSE=${SEND_WHATSAPP_RESPONSE:-"TRUE"} # "TRUE" or "FALSE"
